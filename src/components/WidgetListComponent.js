        ...
        <div className="row">
            ...
            <div className="col-sm-2">
                <div class="form-check float-right" style={{ paddingTop: 10, width: 100 }}>
                    <input class="form-check-input" type="checkbox" value="" id="check" onChange={() => togglePreview()} />
                    ...
                    if (preview) {
                        return <div>
                            <li className="list-group-item">
                                ...
                                {widget.type === "LINK" && <LinkWidget widget={widget} updateWidget={updateWidget} preview={preview} />}
                            </li>
                            <br />
                        </div>
                    }

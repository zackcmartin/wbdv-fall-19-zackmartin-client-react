        ...
        if (index == 0) {
            ...
            return <div>
                <li className="list-group-item">
                    ...
                    {widget.type === "LIST" && <ListWidget widget={widget} updateWidget={this.props.updateWidget} />}
                    {widget.type === "PARAGRAPH" && <ParagraphWidget widget={widget} updateWidget={this.props.updateWidget} />}
                    {widget.type === "IMAGE" && <ImageWidget widget={widget} updateWidget={this.props.updateWidget} />}
                    {widget.type === "LINK" && <LinkWidget widget={widget} updateWidget={this.props.updateWidget} />}
                </li>
                <br />
            </div>
        }
